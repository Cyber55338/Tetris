...
const NodeDefinitions = {
    ...
    'Thought': {
        ...
        properties: [
            ...
            { name: 'fallbackAction', type: 'select', default: 'Generate Question to answer', options: ['Generate Question to answer', 'Generate instructions to imagine and answer'] },
            { name: 'visualization', type: 'select', default: 'Sphere', options: ['Sphere', 'Rectangular'] }
        ]
    },
    'Emotion': {
        title: 'Emotion',
    ...
    'Questionnaire (test)': {
        ...
        properties: [
            { name: 'question', type: 'text', default: '' },
